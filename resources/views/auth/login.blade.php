...
<body>
    <div class="flex flex-col items-center justify-center min-h-screen bg-primary-color">
        <div class="p-10 rounded-xl shadow-lg bg-secondary-color w-80 sm:w-96 md:w-[420px]">
            ...
            <div class="mt-6 text-center">
                <p class="text-xs md:text-sm text-text-primary-color font-poppins">Don't have an account? <a
                        href="{{ url('register') }}" class="text-accent-color hover:underline">Sign up</a></p>
            </div>
        </div>
        @if ($errors->any())
