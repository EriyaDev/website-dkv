...
<body>
    <div class="flex flex-col items-center justify-center min-h-screen py-2 bg-primary-color">
        <div class="p-5 sm:p-10 rounded-xl shadow-lg bg-secondary-color w-[90%] sm:w-96 md:w-[420px]">
        ...
        @if ($errors->any())
            <div class="mt-5 w-[90%] sm:w-96 md:w-[420px] bg-red-500 text-sm text-white rounded-lg p-4 mb-2">
