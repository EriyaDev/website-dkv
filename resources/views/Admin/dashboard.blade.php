<x-dashboard-layout>
    <div class="grid grid-cols-1 gap-5">
        <div class="flex flex-row items-center">
            <a href="" class="page-title">Selamat Datang, Admin!</a>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div class="card-dashboard">
                <h1 class="card-text-inactive text-lg">Total Guru</h1>
                <h1 class="card-text-active text-3xl">{{ $teachers }} </h1>
            </div>
            <div class="card-dashboard">
                <h1 class="card-text-inactive text-lg">Total Kelas</h1>
                <h1 class="card-text-active text-3xl">{{ $classes }} </h1>
            </div>
            <div class="card-dashboard">
                <h1 class="card-text-inactive text-lg">Total Ruang</h1>
                <h1 class="card-text-active text-3xl">{{ $rooms }} </h1>
            </div>
            <div class="card-dashboard">
                <h1 class="card-text-inactive text-lg">Total Mata Pelajaran</h1>
                <h1 class="card-text-active text-3xl">{{ $subjects }} </h1>
            </div>
        </div>
