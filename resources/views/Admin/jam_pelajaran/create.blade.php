<x-dashboard-layout>
    ...
    <div class="box-dashboard">
        <form action="{{ url('admin/jam-pelajaran') }}" method="POST">
            @csrf
            ...
            <div class="input-container">
                <div class="input-group">
                    ...
                    <x-input id="jam_pelajaran_ke" type="number" :disabled="false" name="jam_pelajaran_ke"
                        value="" placeholder="Masukan jam pelajaran"></x-input>
                </div>
                <div class="input-group">
                    <x-label for="jam_mulai">Jam Mulai</x-label>
                    <x-input id="jam_mulai" type="time" :disabled="false" name="jam_mulai" value=""
                        placeholder="Masukan jam mulai"></x-input>
                </div>
                <div class="input-group">
                    <x-label for="jam_selesai">Jam Selesai</x-label>
                    <x-input id="jam_selesai" type="time" :disabled="false" name="jam_selesai" value=""
                        placeholder="Masukan jam selesai"></x-input>
                </div>
            </div>
